...
var HumidityAnalysisPageModule = /** @class */ (function () {
    function HumidityAnalysisPageModule() {
    }
    ...
    return HumidityAnalysisPageModule;
}());
...
var HumidityAnalysisPage = /** @class */ (function () {
    function HumidityAnalysisPage(navCtrl, router) {
        var _this = this;
    ...
    HumidityAnalysisPage.prototype.ngOnInit = function () {
    };
    HumidityAnalysisPage.prototype.segmentChanged = function (ev) {
        this.category = ev.detail.value;
        console.log(ev);
    };
    HumidityAnalysisPage.prototype.getTempRecentStatus = function () {
        this.recentTemp = 32;
    ...
    HumidityAnalysisPage.prototype.getTempDailyStatus = function () {
        this.dailyTemp = 24;
        if (this.category === 'celcius') {
    ...
    HumidityAnalysisPage.prototype.getTempWeeklyStatus = function () {
        this.weeklyTemp = 27;
        if (this.category === 'celcius') {
    ...
    HumidityAnalysisPage.prototype.getHumRecentStatus = function () {
        this.recentHum = 70;
    ...
    HumidityAnalysisPage.prototype.getHumDailyStatus = function () {
        this.dailyHum = 85;
        if (this.category === 'other') {
    ...
    HumidityAnalysisPage.prototype.getHumWeeklyStatus = function () {
        this.weeklyHum = 79;
        return this.weeklyHum;
    };
    HumidityAnalysisPage.prototype.getPowRecentStatus = function () {
        this.recentPow = 70;
    ...
    HumidityAnalysisPage.prototype.getPowDailyStatus = function () {
        this.dailyPow = 85;
        if (this.category === 'kwh') {
    ...
    HumidityAnalysisPage.prototype.getPowWeeklyStatus = function () {
        this.weeklyPow = 73;
        return this.weeklyPow;
    };
    HumidityAnalysisPage.prototype.getCurRecentStatus = function () {
        this.recentCur = 3;
        if (this.category === 'A') {
    ...
    HumidityAnalysisPage.prototype.getCurDailyStatus = function () {
        this.dailyCur = 2.5;
        if (this.category === 'A') {
    ...
    HumidityAnalysisPage.prototype.getCurWeeklyStatus = function () {
        this.weeklyCur = 2;
        if (this.category === 'A') {
    ...
    HumidityAnalysisPage.prototype.getVolRecentStatus = function () {
        this.recentVol = 15;
        if (this.category === 'V') {
    ...
    HumidityAnalysisPage.prototype.getVolDailyStatus = function () {
        this.dailyVol = 11;
        if (this.category === 'V') {
    ...
    HumidityAnalysisPage.prototype.getVolWeeklyStatus = function () {
        this.weeklyVol = 9.6;
        if (this.category === 'V') {
    ...
    HumidityAnalysisPage.prototype.goToTemperatureAnalysis = function () {
        console.log("Pressed voltage");
        this.navCtrl.navigateRoot('/ac-analysis');
    };
    HumidityAnalysisPage.prototype.goToHumidityAnalysis = function () {
        console.log("Pressed voltage");
        this.navCtrl.navigateRoot('/humidity-analysis');
    };
    HumidityAnalysisPage.prototype.goToVibrationAnalysis = function () {
        console.log("Pressed voltage");
        this.navCtrl.navigateRoot('/vibration-analysis');
    };
    HumidityAnalysisPage.prototype.goToPowerConAnalysis = function () {
        console.log("Pressed voltage");
        this.navCtrl.navigateRoot('/power-consumption-analysis');
    };
    HumidityAnalysisPage.prototype.goToCurrentAnalysis = function () {
        console.log("Pressed voltage");
        this.navCtrl.navigateRoot('/current-analysis');
    };
    HumidityAnalysisPage.prototype.goToVoltageAnalysis = function () {
        console.log("Pressed voltage");
        this.navCtrl.navigateRoot('/voltage-analysis');
    };
    HumidityAnalysisPage.ctorParameters = function () { return [
...
//# sourceMappingURL=main-ac-analysis-humidity-analysis-humidity-analysis-module-es5.js.map