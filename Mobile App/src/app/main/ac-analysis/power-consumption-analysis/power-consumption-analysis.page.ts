...
@Component({
  ...
  templateUrl: './power-consumption-analysis.page.html',
  styleUrls: ['./power-consumption-analysis.page.scss'],
})
export class PowerConsumptionAnalysisPage implements OnInit {
